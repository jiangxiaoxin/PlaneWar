...
class GameLoop {
    ...
    private myLayer: egret.DisplayObjectContainer;
    private enemyLayer: egret.DisplayObjectContainer;
    private enemys: EnemyPlane[];
    ...
    private myPlaneDead(e: egret.Event): void {
    ...
    private onFrame(e: egret.Event): void {
        ...
        for (var k = 0; k < this.enemys.length; k++) {
            ...
            if (myPlaneRetangle.intersects(enemyRectangle)) {
                ...
                var sound: egret.Sound = RES.getRes("explosion_wav");
                sound.play(0, 1);
                k--;
                continue;
            }
            ...
            for (var m = 0; m < this.myPlane.bullets.length; m++) {
                ...
                // if (enemy.hitTestPoint(bulletx, bullety, true)) {
                    ...
                    Utils.removeFromParent(enemy);
                    this.factory.saveClassInstance(EnemyPlane, enemy);
                    var _sound: egret.Sound = RES.getRes("explosion_wav");
                    _sound.play(0, 1);
                    k--;
                    break;
                }
